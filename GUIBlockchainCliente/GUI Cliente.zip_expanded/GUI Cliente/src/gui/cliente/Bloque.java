...
public class Bloque {
	...
	public ArrayList<Transaccion> transacciones = new ArrayList<Transaccion>(); //Los datos serán un mensaje.
	...
	public boolean añadirTransaccion(Transaccion transaccion) {
		//Procesamiento de la transaccion y comprobación de su validez, si no es el bloque origen se ignora.
		...
		System.out.println("La transacción de añadió satisfactoriamente al bloque");
		return true;
	}
