...
public class Hash {
	...
	public static String aplicarSha256(String entrada){
		...
		try {
			...
			StringBuffer cadenaHex = new StringBuffer(); // Contendrá el hash en hexadecimal as hexidecimal
	...
	//Aplicación de la firma ECDSA y devolución del resultado en bytes.
